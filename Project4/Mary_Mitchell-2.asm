...
; Description:  The objective of this assignment is to create a program that will determine if 
;               two strings are anagrams. If the two strings are anagrams, then EAX will have the
;               value 1 after the code has been completed. If they are not anagrams, then EAX
;               will have the value 0. 
; Sources:      project4_template.asm and the project briefing
